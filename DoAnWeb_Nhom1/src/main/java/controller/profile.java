...
public class profile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (mb != null) {
			request.setAttribute("fn", mb.getFirstname());
			request.setAttribute("ln", mb.getLastname());
			request.setAttribute("ph", mb.getPhone());
			request.setAttribute("ds", mb.getDiscription());
